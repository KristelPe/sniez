    ...
    public function up()
    {
        ...
        DB::table('recipes')->insert(
            array(
                ...
                array('title' => 'Champignonroomsaus', 'ingredients' => 'Sjalotten: 2 ; Knoflook: 1 teentje ; Kalfsfond: 300 ml ; Room: 300 ml ; Champignons: 300 g ; Citroensap ; Boter ; Peper ; Zout', 'preparation' => 'blabla')
            )
        );
    }
